            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="meta-containerx container-fluid text-center">
                        <h2 class="project-title"> 1 BHK | Precious Emerald</h2>
                        <p class="project-text"><img src="<?php echo site_url("assets/images/location.png"); ?>" class="contact-info-icon"> Ulwe, Navi Mumbai</p>
                    </div>
                    <div class="swiper-slidex container-fluid" style="border: 3px solid #008DD2; border-radius: 10px;">
                        <div class="row">
                            <div class="img-container col-lg-7 col-md-12 col-sm-12" style="padding:0; overflow: hidden;">
                                <img src="<?php echo site_url("assets/images/pe_hero.jpg"); ?>" class="project-image" style="width: 100%;">
                            </div>
                            <div class="img-container col-lg-5 col-md-12 col-sm-12" style="padding:0; background-color: white;">
                                ...
                                <div class="owl-carousel amenities-carousel" style="font-weight: bold;">
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/clear_title.jpg"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Clear Title</p>
                                    </div>
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/natural_lighting.jpg"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Natural Lighting</p>
                                    </div>
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/no_wastage.jpg"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">No Wastage</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center" style="    margin-top: 10%;">
                        ...
                        <p class="highlights">Rewards yourself with the dream home amidst the best mega-infrastructure projects of India. Best connectivity in local as well as international aspects with Khandeshwar station, MTHL link and Navi Mumbai International Airport at the close proximity respectively. </p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-12 col-sm-12"></div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-12 col-sm-12">
                                            <div class="card-body card-body-corrected-padding text-left feature-card">
                                                ...
                                                <p class="feature-text">Ulwe, Navi Mumbai </p>
                                            </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                            ...
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                                    <a href="<?php echo site_url("assets/pe.pdf"); ?>" target="_blank" download><h5 class="feature-title"  style="font-weight: bold; color: #393185;">Download Brochure</h5></a>
