            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="meta-containerx container-fluid text-center">
                        <h2 class="project-title"> 1 BHK, 2BHK | Precious Heritage</h2>
                        <p class="project-text"><img src="<?php echo site_url("assets/images/location.png"); ?>" class="contact-info-icon"> Joveli, Badlapur</p>
                    </div>
                    <div class="swiper-slidex container-fluid" style="border: 3px solid #008DD2; border-radius: 10px;">
                        <div class="row">
                            <div class="img-container col-lg-7 col-md-12 col-sm-12" style="padding:0; overflow: hidden;">
                                <img src="<?php echo site_url("assets/images/precious_heritage.jpg"); ?>" class="project-image" style="width: 180%;">
                            </div>
                            <div class="img-container col-lg-5 col-md-12 col-sm-12" style="padding:0; background-color: white;">
                                ...
                                <div class="owl-carousel amenities-carousel" style="font-weight: bold;">
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/phe_modern_amenities.jpg"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Modern Amenities</p>
                                    </div>
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/modern_fittings.jpg"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Modern Fittings</p>
                                    </div>
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/spacious_flats.jpg"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Spacious Flats</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center" style="    margin-top: 10%;">
                        ...
                        <p class="highlights">A gateway to modern living in the lap of nature, away from hustle & bustle of the city and strategically located with the best connectivity is the living at Precious Heritage. </p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-12 col-sm-12"></div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-12 col-sm-12">
                                            <div class="card-body card-body-corrected-padding text-left feature-card">
                                                ...
                                                <p class="feature-text">Joveli, Badlapur</p>
                                            </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                            ...
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                                    <a href="<?php echo site_url("assets/phe.pdf"); ?>" target="_blank"><h5 class="feature-title"  style="font-weight: bold; color: #393185;">Download Brochure</h5></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15076.712417639435!2d73.23748887613526!3d19.143679579218787!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x840d41eabc21131a!2sPRECIOUS%20HERITAGE!5e0!3m2!1sen!2sin!4v1622466774599!5m2!1sen!2sin" width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>                                
                            </div>                    
                        </div>
                    </div>
