            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="meta-containerx container-fluid text-center">
                        <h2 class="project-title">1 BHK, 2BHK | Vishwajeet Precious</h2>
                        <p class="project-text"><img src="<?php echo site_url("assets/images/location.png"); ?>" class="contact-info-icon"> Varap Kalyan</p>
                    </div>
                    <div class="swiper-slidex container-fluid" style="border: 3px solid #008DD2; border-radius: 10px;">
                        <div class="row">
                            <div class="img-container col-lg-7 col-md-12 col-sm-12" style="padding:0; overflow: hidden;">
                                <img src="<?php echo site_url("assets/images/vj_precious_hero.jpg"); ?>" class="project-image" style="width: 180%;">
                            </div>
                            <div class="img-container col-lg-5 col-md-12 col-sm-12" style="padding:0; background-color: white;">
                                ...
                                <div class="owl-carousel amenities-carousel" style="font-weight: bold;">
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/meditation_yoga_spaces.png"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Meditation Yoga Spaces</p>
                                    </div>
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/vj_gazebo.png"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Gazebo</p>
                                    </div>
                                    <div class="amenities-slide  text-center">
                                        <img src="<?php echo site_url("assets/images/hi_tech_gym.png"); ?>" style="margin: 0 auto; width: 75%;">
                                        <p class="amenity-title">Gym</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center" style="    margin-top: 10%;">
                        ...
                        <p class="highlights">Where you live, makes who you are. The journey to happiness therefore, begins at home that builds our pride in life and lifestyle. Thus, inspiring the thought of having all that you desire, comes at one place. </p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-12 col-sm-12"></div>
            </div>
    ...
    <section id="features" class="padding-top-bottom-five-em">
        <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-12 col-sm-12">
                                            <div class="card-body card-body-corrected-padding text-left feature-card">
                                                ...
                                                <p class="feature-text">Varap Kalyan</p>
                                            </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                                    <p class="feature-title">Flat Configuration</p>
                                                    <p class="feature-text">1 BHK | 2BHK </p>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                                    <p class="feature-title">MahaRERA registered </p>
                                                    <!-- <p class="feature-text">P1234343</p> -->
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                                <div class="card-body card-body-corrected-padding text-left feature-card">
                                                    <a href="<?php echo site_url("assets/vj_precious.pdf"); ?>" target="_blank"><h5 class="feature-title"  style="font-weight: bold; color: #393185;">Download Brochure</h5></a>
                                                    <!-- <p class="feature-title">DownLoad Brochure</p>
            ...
            <div class="text-center d-none">
                <p class="bold-text-3d-view" style="margin: 1% 0;"> 
                <!-- <img src="<?php echo site_url("assets/images/3d_view_360.png"); ?>" class="features-icon" style="width: 50px; height: 50px;">  -->
                <span style="font-size: 1.3rem; font-weight: bold; margin-right: 3%;">Project Video</span>  <a href="<?php echo site_url("assets/vj_pinkcity_video.mp4") ?>" data-lity class="btn btn-lg" style="background-color: #393185; color: white;">Click to View</a></p>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15067.218587374324!2d73.1706987184326!3d19.24734380766628!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x72a5ac4887aba7b5!2sVishwajeet%20Precious!5e0!3m2!1sen!2sin!4v1622466962322!5m2!1sen!2sin" width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>                                
                            </div>                    
                        </div>
                    </div>
                            ...
                            <div class="col-lg-5 col-md-12 col-sm-12 text-center">
                                <div class="card" id="results-card">
                                    <div class="card-body">
                                        ...
                                        <p class="calculated-amount-wrapper">₹ <span id="caclulated-emi">0</span></p>
                                        <p class="result-title">TOTAL PAYMENT</p>
                                        <p class="result-title">(PRINCIPLE + INTEREST)</p>
                                        <p class="calculated-amount-wrapper">₹ <span id="caclulated-amount">0</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
